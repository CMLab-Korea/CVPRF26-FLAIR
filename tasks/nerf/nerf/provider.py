...
class NeRFDataset:
    def __init__(self, opt, device, type='train', downscale=1, n_test=10, train_skip=None):
        ...
        print(f"🔍 Checking for transforms.json at: {os.path.join(self.root_path, 'transforms.json')}")
        print(f"🔍 Checking for transforms_train.json at: {os.path.join(self.root_path, 'transforms_train.json')}")
