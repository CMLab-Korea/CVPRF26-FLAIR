...
from . import sl2a
    # def get_INR(nonlin, in_features, hidden_features, hidden_layers,
                ...
                # sidelength=512, fn_samples=None, use_nyquist=True,MLP_configs):
...
def get_INR(nonlin, in_features, hidden_features, hidden_layers,
            ...
            init_T=None, init_beta=None, init_zeta=None,
            deg=256, rank=128, nonlinearity='relu',
            init_method='xavier_uniform', linear_init_type='kaiming_uniform',
            **kwargs):
...
"""
    model = inr_mod.INR(in_features, # 2 
                        hidden_features, # 256
                        hidden_layers, # 2
                        out_features, # 3
